              ...
              WHERE
                LEFT(
                  REGEXP_REPLACE(
                    COALESCE(
                      a.card_bin,
                      p.xolvis_payload #>> '{returnData,firstSixDigits}',
                      p.xolvis_payload #>> '{returnData,binDigits}',
                      p.xolvis_payload->>'firstSixDigits',
                      p.xolvis_payload->>'binDigits',
                      ''
                    ),
                    '[^0-9]',
                    '',
                ...
                AND RIGHT(
                  REGEXP_REPLACE(
                    COALESCE(
                      a.last_four,
                      p.xolvis_payload #>> '{returnData,lastFourDigits}',
                      p.xolvis_payload->>'lastFourDigits',
                      ''
                    ),
                    '[^0-9]',
                    '',
